...
class ProductUnitConversionRemoteRepository {
  ...
  Future<bool> push(List<Map<String, dynamic>> records) async {
    try {
      ...
      logSyncFailure('/inventory/product-unit-conversions/push', e);
      return false;
    }
  }
  ...
  Future<List<Map<String, dynamic>>> pull({
    ...
    try {
      ...
      final res = await ApiClient.instance.get(
        '/inventory/product-unit-conversions/pull',
        params: params,
      );
      final data = res.data['data'] as List<dynamic>;
      return data.cast<Map<String, dynamic>>();
    } on DioException catch (e) {
      logSyncFailure('/inventory/product-unit-conversions/pull', e, op: 'pull');
      return [];
    }
  }
}
